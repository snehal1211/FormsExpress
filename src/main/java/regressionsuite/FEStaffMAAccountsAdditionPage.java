...
public class FEStaffMAAccountsAdditionPage extends DriverManager{
    ...
    public FEStaffMAAccountsAdditionPage(TestInit ti) 
	{
		this.ti = ti; 
    ...
    public void UserSearch() throws InterruptedException {
    	...
    	String EmailId="automationaddaccount2@blazeclan.com";
    	Thread.sleep(5000);
    ...
    public void ReferenceNumberAddition() throws InterruptedException {
    	...
    	Thread.sleep(9000);
    //String AcntHolderName="Sandran Pty Ltd";
