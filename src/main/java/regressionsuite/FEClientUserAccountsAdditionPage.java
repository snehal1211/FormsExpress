...
public class FEClientUserAccountsAdditionPage extends DriverManager{
    ...
    public FEClientUserAccountsAdditionPage(TestInit ti) 
	{
		this.ti = ti; 
    ...
    public void UserSearch() throws InterruptedException {
    	...
    	String EmailId="automationaddaccount1@blazeclan.com";
    	Thread.sleep(5000);
